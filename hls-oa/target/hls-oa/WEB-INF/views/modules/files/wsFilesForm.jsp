...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/files/wsFiles/">文件列表</a></li>
		<li class="active"><a href="${ctx}/files/wsFiles/form?id=${wsFiles.id}">文件<shiro:hasPermission name="files:wsFiles:edit">${not empty wsFiles.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="files:wsFiles:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
