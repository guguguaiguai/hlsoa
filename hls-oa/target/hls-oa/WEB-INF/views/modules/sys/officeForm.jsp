	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>
					<form:input path="name" htmlEscape="false" maxlength="50" class="required" style="width:257px;"/>
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<th>拼音码：</th>
				<td>
					<form:input path="pym" htmlEscape="false" maxlength="50" class="required"/>
				</td>
			</tr>
			<tr>
				<th>机构类型：</th>
				<td>
					<form:select path="type" class="input-medium" style="width:270px;">
						<form:options items="${fns:getDictList('sys_office_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</td>
				<th>机构级别：</th>
				<td>
					<form:select path="grade" class="input-medium" style="width:230px;">
			...
			<tr>
				<th>电话：</th>
				<td>
					<form:input path="phone" htmlEscape="false" maxlength="50" style="width:257px;"/>
				</td>
				<th>
					是否可用：
				</th>
				<td>
					...
					<span class="help-inline">“是”代表可用，“否”则表示不可用</span>
				</td>
			</tr>
			<tr>
				<th>备注：</th>
				<td colspan="3">
					<form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge" style="width:740px;"/>
				</td>
			</tr>
		</table>
