...
(
	...
	remarks varchar(255) COMMENT '备注信息',
	del_flag char(1) DEFAULT '0' NOT NULL COMMENT '删除标记',
	file_name varchar(3000) COMMENT '附件名称',
	notify_scope varchar(1) DEFAULT '0' NOT NULL COMMENT '发布范围',
	PRIMARY KEY (id)
) COMMENT = '通知通告';
...
(
	id varchar(64) NOT NULL COMMENT '编号',
	dep_id varchar(64) NOT NULL COMMENT '部门ID',
	read_flag varchar(1) DEFAULT '0' NOT NULL COMMENT '阅读标记',
	read_date date COMMENT '阅读时间',
	notify_id varchar(64) NOT NULL COMMENT '公告ID',
