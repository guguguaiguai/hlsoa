...
import com.lq.work.common.web.Servlets;
...
import com.lq.work.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		if (user != null) {
			...
			//SimpleAuthenticationInfo authen=new SimpleAuthenticationInfo(new Principal(user, token.isMobileLogin()), 
	...
	/**
	 * 设定密码校验的Hash算法与迭代次数,此处可自定义密码匹配规则验证
	 */
	@PostConstruct
