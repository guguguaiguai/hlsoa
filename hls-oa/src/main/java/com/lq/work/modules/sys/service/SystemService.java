...
import com.lq.work.common.security.Digests;
import com.lq.work.common.security.shiro.session.SessionDAO;
import com.lq.work.common.service.BaseService;
import com.lq.work.common.service.ServiceException;
...
import com.lq.work.modules.sys.dao.MenuDao;
import com.lq.work.modules.sys.dao.RoleDao;
import com.lq.work.modules.sys.dao.UserDao;
...
import com.lq.work.modules.sys.security.SystemAuthorizingRealm;
import com.lq.work.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void updatePasswordById(String id, String loginName, String newPassword) {
		...
		try {
			user.setPassword(MD5Util.encodeByMD5(loginName+newPassword));
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean validatePassword(String plainPassword, String password) {
		...
		//String pp=MD5Util.encodeByMD5(plainPassword);
		//Boolean f=StringUtils.equals(password, pp);
		return password.equals(MD5Util.encodeByMD5(plainPassword));
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<OaNotify> mainNotify(OaNotify oaNotify){
		return this.oaNotifyDao.mainNotify(oaNotify);
	}
	@Autowired
	 ...
	 * @author JERRY
	 * **/
	public List<InternalReceive> mainInternal(InternalReceive mr){
		return this.internalReceiveDao.mainInternalReceive(mr);
	}
	@Autowired
	 ...
	 * @author JERRY
	 * **/
	public List<WsNews> mainNews(WsNews wsNews){
		return this.wsNewsDao.mainNews(wsNews);
	}
	@Autowired
	private MsgEmailDao msgEmailDao;
	/**
	 * 内部邮件
	 * **/
	public List<MsgEmail> mainMail(MsgEmail msgEmail){
		return this.msgEmailDao.mainMail(msgEmail);
	}
	/**
	 * 更新人员信息
	 * @author JERRY
	 * **/
	public Map hisUser(Map map){
		return userDao.hisUser(map);
	}
	/**
	 * 根据邮件接收者查询接收用户信息
	 * @author JERRY
	 * **/
	public List<User> receiveUser(List<String> ids){
		return userDao.receiveUser(ids);
	}
}
