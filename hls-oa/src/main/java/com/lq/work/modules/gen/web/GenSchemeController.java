 ...
 * 
 */
package com.lq.work.modules.gen.web;
...
import com.lq.work.modules.gen.service.GenSchemeService;
import com.lq.work.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.lq.work.modules");
		}
