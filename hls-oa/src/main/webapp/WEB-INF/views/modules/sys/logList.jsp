...
<!-- 	</ul> -->
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th><input type="checkbox" id="log_check" /></th><th>操作菜单</th><th>操作用户</th><th>所在院区</th><th>所在科室</th><th>URI</th><th>提交方式</th><th>操作者IP</th><th>操作时间</th></thead>
		<tbody><%request.setAttribute("strEnter", "\n");request.setAttribute("strTab", "\t");%>
		<c:forEach items="${page.list}" var="log">
			<tr>
				<td>
					<input type="checkbox" name="list_check" value="${log.id}" />
				</td>
				<td>${log.title}</td>
