				...
				<ul id="userControl" class="nav pull-right">
					...
					<li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#" title="消息">
                                <i class="icon-bell-alt"></i> <span class="label badge badge-info" id="msg_count"></span>
                            </a>
						...
						<li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#" title="内部邮件">
                                <i class="icon-envelope-alt"></i> <span class="label badge badge-info" id="mail_count"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-alerts">
                                <li>
                                    <a href="javascript:void(0);">
