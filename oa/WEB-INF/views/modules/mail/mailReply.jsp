            ...
            <div class="row span10" style="width: 100%;padding: 0px 5px;">
				...
				<div class="mail-box">
                    <div class="mail-body">
						...
						<form:form id="inputForm" modelAttribute="msgEmail" style="padding-top: 40px" action="${ctx}/mail/msgEmail/replySave" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" style="width:70px;">主&nbsp;&nbsp;题0：</label>
                                <div class="col-sm-10">
					...
					<div class="container" style="position:absolute;height:400px;top:60px;right:5px;width:20%;border:1px solid #7f9db9">
							<ul class="tabs">  
