	...
	<div class="container-fluid">
        <div class="row-fluid show-grid">
            ...
            <div class="row span10" style="width: 100%;padding: 0px 5px;">
				...
				<div class="mail-box">
                    <div class="mail-body">
                        <form:form id="inputForm" modelAttribute="msgEmail" style="padding-top: 40px" action="${ctx}/mail/msgEmail/forwardSave" method="post" class="form-horizontal">
					...
					<div class="container" style="position:absolute;height:375px;top:60px;right:30px;width:20%;border:1px solid #7f9db9">
							<ul class="tabs">
