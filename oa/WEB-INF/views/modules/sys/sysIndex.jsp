...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#userInfo .dropdown-menu a,#msg_all,#mail_all").mouseup(function(){
			...
			function getNotifyNum(){
				$.getJSON("${ctx}/oa/oaNotify/count?updateSession=0&t="+new Date().getTime(),function(data){
					var num = parseFloat(data.notifyCount);
					if (num > 0){
					...
					/*消息数量*/
					var msg_num = parseFloat(data.msgCount);
					if(msg_num>0){
						$("#msg_count,#msg_info").show().html(msg_num);
					}else{
						$("#msg_info").html(msg_num);
						$("#msg_count").hide();
					}
					/*内部邮件数量*/
					var mail_num = parseFloat(data.mailCount);
					if(mail_num>0){
						$("#mail_count,#mail_info").show().html(mail_num);
					}else{
						$("#mail_info").html(mail_num);
						$("#mail_count").hide();
					}
				});
			}
...
<body>
<div class="hide">
	<a class="menu" href="${ctx}/common/system/main" id="main_page"><i class="icon-home"><span>主页</span></i></a>
</div>
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li class="dropdown">
                            <!--<a class="dropdown-toggle count-info" data-toggle="dropdown" href="#" title="消息">
                                <i class="icon-bell-alt"></i> <span class="label badge badge-info" id="msg_count"></span>（消息）
                            </a>-->
						<a id="msg_all" href="${ctx}/message/internalReceive/unreadList" target="mainFrame"><i class="icon-bell-alt"/></i>&nbsp;我的消息<span class="label badge badge-info" id="msg_count"></span></a>
                            <ul class="dropdown-menu dropdown-alerts">
                                <li>
                                    <a href="javascript:void(0);">
                                        <div>
                                            <i class="fa fa-envelope fa-fw"></i> 您有<span id="msg_info"></span>条未读消息
                                ...
                                <li>
                                    <div class="text-center link-block">
                                       <!-- <a id="msg_all" href="${ctx}/message/internalReceive/unreadList" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的消息</a>-->
                                    </div>
                                </li>
                            </ul>
                        </li>
						<li class="dropdown">
                            <!--2017-1-15
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#" title="内部邮件">
                            --><a id="mail_all" href="${ctx}/mail/msgEmail/index" target="mainFrame"><i class="icon-envelope-alt"></i>&nbsp;我的邮箱<span class="label badge badge-info" id="mail_count"></span></a>
                                <!--<i class="icon-envelope-alt"></i> <span class="label badge badge-info" id="mail_count"></span>（内部邮件）-->
                            </a>
                            <ul class="dropdown-menu dropdown-alerts">
                                <li>
                                    <a href="javascript:void(0);">
                                        <div>
                                            <i class="fa fa-envelope fa-fw"></i> 您有<span id="mail_info"></span>条未读邮件
                                            <!--<span class="pull-right text-muted small">4分钟前</span>-->
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <div class="text-center link-block">
                                       <!-- <a id="mail_all" href="${ctx}/mail/msgEmail/index" target="mainFrame"><i class="icon-envelope-alt"></i>&nbsp;  我的邮箱</a>-->
                                    </div>
                                </li>
                            </ul>
                        </li>
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/oa/oaNotify/index" target="mainFrame"><i class="icon-bullhorn"></i>&nbsp;  我的通告 <span id="notifyNum2" class="label label-info hide"></span></a></li>
							<li><a href="${ctx}/message/msgInternal" target="mainFrame"><i class="icon-bell"></i>&nbsp;  内部消息 <span id="notifyNum3" class="label label-info hide"></span></a></li>
						</ul>
					</li>
