...
<head>
	...
	<style type="text/css">
	  ...
	  .footer_{color:#fff;position:relative;margin:10px;}
    </style>
...
<body>
	...
	<div style=""><a target="blank" href="http://10.36.10.200:8080/oa" style="float:right;padding-top:10px;padding-right:20px;color:#08059A;font-weight:bold;">旧版OA系统登录</a></div>
	<div class="header">
	...
	<div id="browser_info"  style="position:relative;width:250px;margin:0;text-align:center;padding-top:40%;"><a href="../browser/chrome.zip"><img src="../browser/20160421023846525.png" height="50px" width="30px"></a>&nbsp;&nbsp;&nbsp;<a href="../browser/IE8-For-XP.zip"><img src="../browser/0058eaf1ac.png" height="50px" width="30px"></a>&nbsp;&nbsp;&nbsp;<a href="../browser/FireFox.zip" ><img src="../browser/1-140FZ6493O08.png" height="50px" width="30px"></a></div>
