            ...
            <div class="row span12">
                <div class="mail-box-header">
					<div class="pull-right tooltip-demo" id="btn_detail">
							<input id="mail_reply" class="btn btn-primary btn-sm" type="button" value="回复" reply_="${mmail.id}"/>
							<input id="mail_forward" class="btn btn-primary btn-sm" type="button" value="转发" mf_="${mmail.id}"/>
							<input id="btn_del" class="btn btn-primary btn-sm" type="button" value="删除" del_="${mmail.id}"/>
					</div>
                    <h2>
